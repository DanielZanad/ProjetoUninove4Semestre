function livro(){
    ...
    img2.src = "./img/narutin.png";
    titulo2.innerHTML = "Mangá Naruto Vol.2";
    preco2.innerHTML = "R$ 30,00";
    alert("fdsfdsafs")

    let titulo3 = document.getElementById("pImg3");
    let preco3 = document.getElementById("p2Img3");
    let img3 = document.getElementById("img3");
    img3.src = "./img/narutin.png";
    titulo3.innerText = "Mangá Naruto Vol.2";
    ...
    img4.src = "./img/narutin.png";
    titulo4.innerText = "Mangá Naruto Vol.2";
    preco4.innerText = "R$ 30,00";
